...
namespace FakeProjectG.Tools
{
    public class IniFile
    {
        ...
        /// <param name="def">padrao = caso não encontre o valor no key, retorna o def</param>
        /// <returns>string</returns>
        public Char ReadChar(string section, string key, object def)
        {
            StringBuilder SB = new StringBuilder(255);
        ...
        {
            StringBuilder SB = new StringBuilder(255);
            int i = GetPrivateProfileString(section, key, def.ToString(), SB, 255, this.FilePath);
